...
const Support = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      Get help, find answers, and connect with Neuralyn support for all your needs.
    </motion.p>
    <motion.div
    ...
    >
      <h2 className="text-2xl font-semibold mb-4">Support resources will be available soon.</h2>
    </motion.div>
  </div>
);

...
const API = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      Integrate Neuralyn's AI healthcare solutions into your own applications and workflows.
    </motion.p>
    <motion.div
    ...
    >
      <h2 className="text-2xl font-semibold mb-4">API access will be available soon.</h2>
    </motion.div>
  </div>
);

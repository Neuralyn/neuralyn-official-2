...
const SmartHospitals = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      Transforming hospitals with AI-driven automation, patient monitoring, and operational intelligence for the future of healthcare.
    </motion.p>
    <motion.div
    ...
    >
      ...
      <p className="text-white/70 text-lg">Neuralyn will enable smart, connected hospitals with AI-powered systems for patient care, resource management, and seamless integration across healthcare networks.</p>
    </motion.div>
  </div>
);

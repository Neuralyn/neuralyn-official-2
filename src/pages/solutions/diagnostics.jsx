...
const Diagnostics = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      AI-powered diagnostics for faster, more accurate detection and intervention across a range of health conditions.
    </motion.p>
    <motion.div
    ...
    >
      ...
      <p className="text-white/70 text-lg">Neuralyn will provide real-time, AI-driven diagnostic tools, integrating with hospitals and clinics to enable early detection, personalized treatment, and improved patient outcomes worldwide.</p>
    </motion.div>
  </div>
);

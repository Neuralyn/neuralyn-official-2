...
const NeuraDiet = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      AI-powered nutrition and lifestyle planning system. Personalized meal plans, nutritional analysis, and lifestyle recommendations for optimal health.
    </motion.p>
    <motion.div
    ...
    >
      ...
      <p className="text-white/70 text-lg">This is a future product page for NeuraDiet. Here, you will find detailed features, benefits, and how to get started with our AI-powered nutrition and lifestyle solution.</p>
    </motion.div>
  </div>
);

export default NeuraDiet; 
...
const VoxHeart = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      Advanced AI system for heart disease prediction and prevention. Early detection, risk analysis, and personalized care for a healthier heart.
    </motion.p>
    <motion.div
    ...
    >
      ...
      <p className="text-white/70 text-lg">This is a future product page for VOXHEART. Here, you will find detailed features, benefits, and how to get started with our AI-powered heart health solution.</p>
    </motion.div>
  </div>
);

export default VoxHeart; 